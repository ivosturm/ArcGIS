...
], function (declare, dom, dojoDom, on, domClass, parser,_WidgetBase, _TemplatedMixin, domStyle, domConstruct, arrayUtils, event, lang, baseUnload, cookie, JSON, registry, widgetTemplate,esriConfig,TemplatePicker,BasemapToggle,
 BorderContainer, ContentPane, Toolbar, Button, AccordionContainer) {
    'use strict';
